...
namespace UnionAvatars.VRUI
{
    public class RegisterUI : UIModule
    {
        ...
        public async Task<bool> CheckUsername()
        {
            ...
            WebResponse<string> userExistsResponse = await WebRequests.Send<string>(uiManager.session.SessionContext.Url + "users/exists/username/" + usernameField.text,
                                                                                    "GET",
        ...
        public async Task<bool> CheckEmail()
        {
            ...
            WebResponse<string> userExistsResponse = await WebRequests.Send<string>(uiManager.session.SessionContext.Url + "users/exists/email/" + emailField.text,
                                                                                    "GET",
                                                                                    uiManager.session.SessionContext);
