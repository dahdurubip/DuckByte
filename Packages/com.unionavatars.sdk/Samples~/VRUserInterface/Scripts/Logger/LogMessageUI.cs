...
{    
    public class LogMessageUI : MonoBehaviour
    {
        ...
        private Color32 successColor = new Color32(32, 230, 40, 255);
        ...
        public void SetupLog(string title, string message, AvatarSDKLogType logType)
        {
            ...
            switch(logType)
            {
                ...
                case AvatarSDKLogType.Error:
                    ...
                    break;
                case AvatarSDKLogType.Success:
                    successColor.a = (byte)(Background.color.a * 255);
                    Background.color = successColor;
                    successColor.a = (byte)(Border.color.a * 255);
