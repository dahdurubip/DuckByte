...
public class DialogueData : MonoBehaviour
{
    ...
    public Dictionary<string, string[]> interactables = new Dictionary<string, string[]>()
    {
        ...
        { "northRoom", new string[] { "이 방… 누가 한동안 머물렀던 흔적이 남아 있다."," 정리가 잘 안되 있는데, 벽에 왜 손자국…"," 누가 여기서 살았던 거지?"," 그런데, 왜 이렇게 서늘하지…?" } },
        { "souththRoom", new string[] { "붉은 파편마다 사라진 이름 한 조각… 그건 내가 피로 덮어 숨긴 죄목이었지." } },
        { "eastRoom", new string[] { "순서를 잊는 순간 저주가 길을 삼켜, 우리 가문은 또 하나의 혼을 잃었지..", " 방금 깜빡인 불빛을 그대로 불러내—그러면 나도, 너도, 집으로 돌아갈 수 있어" } },
        { "westRoom", new string[] { "맑은 종소리가 울려 퍼지자, 차가운 은빛 선이 벽을 갈라놓는다.", " 뒤이어 나무를 두드리는 떨림이, 먼 어둠 속 잠든 그림자를 깨운다.", " 마지막으로 무당의 방울이 떨리며, 앞을 가린 안개를 살며시 밀어낸다.", " 울림마다 숨을 고르고, 발끝보다 가벼운 걸음으로 흔적을 더듬어라." } },
    };
}