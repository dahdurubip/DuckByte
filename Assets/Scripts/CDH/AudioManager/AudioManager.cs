...
public class AudioManager : MonoBehaviour
{
    ...
    public enum sfx 
    {
        NRwCry, NRlighter, NRwind, NRknock, NRhorror, NRthunderstorm, NRbigFire, PbabyCry, Pwall, Phorror, PwaterDrop, PlayerWalk, PlayerRun, PlayerBreathe, PlayerItem, PlayerwalkSlowly,
    }
    ...
    //    // 모든 채널이 재생 중이라 빈 곳 없음 → 가장 오래된 채널 강제로 덮어쓰기
    //    channelIndex = (channelIndex + 1) % sfxPlayers.Length;
    //    sfxPlayers[channelIndex].Stop();
